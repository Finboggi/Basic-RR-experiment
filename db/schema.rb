...
ActiveRecord::Schema.define(version: 20171112115559) do
  ...
  create_table "links", force: :cascade do |t|
    ...
    t.index ["product_id", "shop_id"], name: "index_links_on_product_id_and_shop_id", unique: true
    t.index ["product_id"], name: "index_links_on_product_id"
    t.index ["shop_id"], name: "index_links_on_shop_id"
  end
